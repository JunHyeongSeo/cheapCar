			 ...
			 <div class="col-lg-10">
                ...
                <div class="content_outer">
                    <div class="content_header">
                        <div class="content_header2">1</div>
                    </div>
                    <div class="content_sub">
                        <span class="content_sub1">작성일 : 2</span> &nbsp;/&nbsp;
                        <span class="content_sub1">작성자 : 2</span> &nbsp;/&nbsp;
                        <span class="content_sub1">조회수 : 2</span>
                    </div>
                    <div class="content_body">3</div>
