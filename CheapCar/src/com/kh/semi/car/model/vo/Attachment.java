...
public class Attachment {
	...
	public String toString() {
		return "Attachment [carPhotoNo=" + carPhotoNo + ", carPhotoAddress=" + carPhotoAddress + ", managementNo="
				+ managementNo + ", originName=" + originName + ", changeName=" + changeName + ", status=" + status
				+ "]";
	}
